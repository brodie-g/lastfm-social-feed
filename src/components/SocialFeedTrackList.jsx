...
import SocialFeedTrack from "./SocialFeedTrack.jsx";

export default class SocialFeedTrackList extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        usersToShow = usersToShow.map(function (user) {
            return (
                <SocialFeedTrack key={user.name} user={user} maxCount={maxCount} />
            );
        });
